...
def main(paths, day=2, camera=3, initial_frame=0, num_frames=36000, N_pruning=0):
    ...
    # Read results
    r_name = trk_path+'Results_day'+str(day)+'_cam'+str(camera)+'_'+str(N_pruning)+'_'+str(initial_frame)+'-'+str(final_frame)+'.csv'
    ...
    id_name = trk_path+'IDInfo_day'+str(day)+'_cam'+str(camera)+'_'+str(N_pruning)+'_'+str(initial_frame)+'-'+str(final_frame)+'.csv'
...
if __name__ == '__main__':
    ...
    try:
        ...
        print('Usage:\n\tpython3 tracker_ids_study.py day camera initial_frame num_frames N_pruning\n')
        print('Example:\n\tpython3 tracker_ids_study.py 2 3 700 300 0\n')
        sys.exit()
